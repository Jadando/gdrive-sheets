...
const credentialsPath = process.env.GDRIVE_CREDENTIALS_PATH || path.join(path.dirname(fileURLToPath(import.meta.url)), "./token.json" // <-- Aqui está o token gerado via navegador
);
...
async function loadCredentialsAndRunServer() {
    ...
    const oAuth2Client = new google.auth.OAuth2(client_id, client_secret, redirect_uris[0] // mesmo redirect URI usado na autenticação inicial
    );
    // Carrega os tokens
